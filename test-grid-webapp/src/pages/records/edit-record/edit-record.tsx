...
import { createRecord, getRecord, updateRecord } from "../records.service";

function EditRecord({ recordId = 0, closeModal }: IEditRecordComponent): ReactElement {
    ...
    <Form className="d-flex flex-wrap">
      ...
      <div className="d- flex flex-column w-50 p-3">
        <Form.Group className="mb-3 w-100">
          ...
          <Form.Select onChange={handleSelectStatus} name="status" value={record.status.toLowerCase()}>
        ...
        <Form.Group className="mb-3 w-100">
          ...
          <Form.Control onChange={handleChangeName} value={record.name} type="text" id="name" name="name" />
        </Form.Group>
      ...
      <div className="d- flex flex-column w-50 p-3">
        ...
        <Form.Group className="mb-3 w-100">
          ...
          <Form.Control onChange={handleChangeAddress} value={record.address} type="text" id="address" name="address" />
        </Form.Group>
      </div>
